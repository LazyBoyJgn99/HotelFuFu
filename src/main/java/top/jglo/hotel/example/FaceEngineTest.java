...
//        System.out.println(face3dCode);
    ...
    public synchronized String play(){
        FaceEngineTest.ImageInfo imageInfo = getRGBData(new File("src/3.jpg"));
        FaceEngineTest.ImageInfo imageInfo2 = getRGBData(new File("src/2.jpg"));
        FaceEngineTest.ImageInfo imageInfo3 = getRGBData(new File("src/1.jpg"));
        //人脸检测
        List<FaceInfo> faceInfoList = new ArrayList<FaceInfo>();
        getFaceEngine().detectFaces(imageInfo.getRgbData(), imageInfo.getWidth(), imageInfo.getHeight(), ImageFormat.CP_PAF_BGR24, faceInfoList);
        System.out.println(faceInfoList.toString());

        //提取人脸特征
        FaceFeature faceFeature = new FaceFeature();
        getFaceEngine().extractFaceFeature(imageInfo.getRgbData(), imageInfo.getWidth(), imageInfo.getHeight(), ImageFormat.CP_PAF_BGR24, faceInfoList.get(1), faceFeature);

        //        System.out.println(faceFeature.getFeatureData());
//        System.out.println(Arrays.toString(faceFeature.getFeatureData()));
//        System.out.println(faceFeature.toString());

        getFaceEngine().detectFaces(imageInfo3.getRgbData(), imageInfo3.getWidth(), imageInfo3.getHeight(), ImageFormat.CP_PAF_BGR24, faceInfoList);
        System.out.println(faceInfoList.toString());

        getFaceEngine().detectFaces(imageInfo2.getRgbData(), imageInfo2.getWidth(), imageInfo2.getHeight(), ImageFormat.CP_PAF_BGR24, faceInfoList);
        System.out.println(faceInfoList.toString());
        FaceFeature faceFeature2 = new FaceFeature();
        getFaceEngine().extractFaceFeature(imageInfo2.getRgbData(), imageInfo2.getWidth(), imageInfo2.getHeight(), ImageFormat.CP_PAF_BGR24, faceInfoList.get(0), faceFeature2);
//        System.out.println(faceFeature2.getFeatureData());
//        System.out.println(Arrays.toString(faceFeature2.getFeatureData()));
//        System.out.println(faceFeature2.toString());
...
//        System.out.println(sourceFaceFeature.toString());
        ...
        FaceSimilar faceSimilar = new FaceSimilar();
        getFaceEngine().compareFaceFeature(targetFaceFeature, sourceFaceFeature, faceSimilar);
        System.out.println(faceSimilar.toString());
